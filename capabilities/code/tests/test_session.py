...
class TestContextLayerSimilarity:
    ...
    def test_file_path_mention_boosts_context_sim(self, encoder):
        ...
        g1 = _encode_note(encoder, "Changed ada_code/encoder.py to add session tools", "a")
        g2 = _encode_note(encoder, "Updated ada_code/encoder.py with new MCP handlers", "b")
...
class TestSessionScore:
    ...
    def test_combined_score_ranks_correctly(self, encoder):
        ...
        auth_text = "Refactored ada_code/encoder.py auth middleware JWT validation"
    ...
    def test_empty_context_does_not_dominate(self, encoder):
        ...
        rich_text = "Updated ada_code/encoder.py with BeamSearchPredictor temporal tracking"
