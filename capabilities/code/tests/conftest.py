"""Shared test fixtures for the Ada Code model."""
...
# Ensure ada SDK and model root are importable
sys.path.insert(0, str(Path(__file__).parent.parent))  # model-code/
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "ada-runtime"))
