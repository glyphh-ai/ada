"""Similarity and routing accuracy tests for the Ada Code model."""
...
class TestSectionScoring:
    ...
    def test_token_savings_on_real_file(self, encoder):
        """Verify ada_context achieves meaningful line reduction on a real file."""
        from pathlib import Path as P
        content = (P(__file__).parent.parent / "encoder.py").read_text()
